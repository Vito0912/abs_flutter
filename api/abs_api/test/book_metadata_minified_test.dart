...
// tests for BookMetadataMinified
void main() {
  final instance = BookMetadataMinifiedBuilder();
  // TODO add properties to the builder and call build()

  group(BookMetadataMinified, () {
    ...
    test('to test the property `publishedYear`', () async {
      // TODO
    });
    ...
    test('to test the property `titleIgnorePrefix`', () async {
      // TODO
    });
    ...
    // String authorNameLF
    test('to test the property `authorNameLF`', () async {
      // TODO
    });

    // The name of the audiobook's narrator(s).
    // String narratorName
    test('to test the property `narratorName`', () async {
      // TODO
    });
