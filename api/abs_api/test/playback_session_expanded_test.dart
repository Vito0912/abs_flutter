...
// tests for PlaybackSessionExpanded
void main() {
  final instance = PlaybackSessionExpandedBuilder();
  // TODO add properties to the builder and call build()

  group(PlaybackSessionExpanded, () {
    ...
    // PlaybackSessionMediaMetadata mediaMetadata
    test('to test the property `mediaMetadata`', () async {
      // TODO
    });
    ...
    test('to test the property `displayAuthor`', () async {
      // TODO
    });
    ...
    // int playMethod
    test('to test the property `playMethod`', () async {
      // TODO
    });

    // The media player used to play the media.
    // String mediaPlayer
    test('to test the property `mediaPlayer`', () async {
      // TODO
    });
    ...
    // The total length (in seconds) of the item or file.
    // num timeListening
    test('to test the property `timeListening`', () async {
      // TODO
    });
    ...
    // BuiltList<AudioTrack> audioTracks
    test('to test the property `audioTracks`', () async {
      // TODO
    });

    // The video track of the media. TODO
    // JsonObject videoTrack
    test('to test the property `videoTrack`', () async {
      // TODO
    });
