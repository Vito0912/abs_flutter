...
class LibrariesApi {
  ...
  const LibrariesApi(this._dio, this._serializers);

  /// Create a new library on server
  /// Create a new library on server.
  ///
  /// Parameters:
  /// * [createLibraryRequest] - The library object to create.
  ...
  Future<Response<ModelLibrary>> createLibrary({
    ...
    try {
      const _type = FullType(CreateLibraryRequest);
      _bodyData = createLibraryRequest == null
          ? null
          : _serializers.serialize(createLibraryRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ModelLibrary] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelLibrary>> deleteLibraryById({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/libraries/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> deleteLibraryIssues({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/libraries/{id}/issues'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetLibraries200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetLibraries200Response>> getLibraries({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetLibraries200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetLibraries200Response),
            ) as GetLibraries200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetLibraries200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetLibraryAuthors200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetLibraryAuthors200Response>> getLibraryAuthors({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/libraries/{id}/authors'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    GetLibraryAuthors200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetLibraryAuthors200Response),
            ) as GetLibraryAuthors200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetLibraryAuthors200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ModelLibrary] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelLibrary>> getLibraryById({
    required String id,
    String? include,
    int? minified,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (minified != null)
        r'minified':
            encodeQueryParameter(_serializers, minified, const FullType(int)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetLibraryItems200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetLibraryItems200Response>> getLibraryItems({
    required String id,
    int? limit = 0,
    int? page = 0,
    String? sort = 'name',
    ...
    final _path = r'/api/libraries/{id}/items'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (desc != null)
        r'desc': encodeQueryParameter(_serializers, desc, const FullType(int)),
      if (filter != null)
        r'filter':
      ...
      if (collapseSeries != null)
        r'collapseSeries': encodeQueryParameter(
            _serializers, collapseSeries, const FullType(int)),
    };
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetLibraryItems200Response),
            ) as GetLibraryItems200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetLibraryItems200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetLibrarySeries200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetLibrarySeries200Response>> getLibrarySeries({
    required String id,
    int? limit = 0,
    int? page = 0,
    String? sort = 'name',
    ...
    final _path = r'/api/libraries/{id}/series'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    GetLibrarySeries200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetLibrarySeries200Response),
            ) as GetLibrarySeries200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetLibrarySeries200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SeriesWithProgressAndRSS] as data
  /// Throws [DioException] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<SeriesWithProgressAndRSS>> getLibrarySeriesById({
    required String id,
    ...
    final _path = r'/api/libraries/{id}/series/{seriesId}'
        .replaceAll(
            '{' r'id' '}',
            encodeQueryParameter(_serializers, id, const FullType(String))
                .toString())
        .replaceAll(
            '{' r'seriesId' '}',
            encodeQueryParameter(_serializers, seriesId, const FullType(String))
                .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    SeriesWithProgressAndRSS? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SeriesWithProgressAndRSS),
            ) as SeriesWithProgressAndRSS;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Parameters:
  /// * [id] - The ID of the library.
  /// * [updateLibraryByIdRequest] - The library object to update.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [ModelLibrary] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelLibrary>> updateLibraryById({
    required String id,
    required UpdateLibraryByIdRequest updateLibraryByIdRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateLibraryByIdRequest);
      _bodyData = _serializers.serialize(updateLibraryByIdRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
