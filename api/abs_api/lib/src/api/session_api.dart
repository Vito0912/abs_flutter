...
class SessionApi {
  ...
  Future<Response<String>> closeSession({
    required String id,
    num? currentTime,
    num? timeListened,
    num? duration,
    ...
    final _path = r'/api/session/{id}/close'.replaceAll(
        '{' r'id' '}',
    ...
    final _queryParameters = <String, dynamic>{
      if (currentTime != null)
        r'currentTime': encodeQueryParameter(
            _serializers, currentTime, const FullType(num)),
      if (timeListened != null)
        r'timeListened': encodeQueryParameter(
            _serializers, timeListened, const FullType(num)),
      if (duration != null)
        r'duration':
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> createLocalSession({
    ...
    final _path = r'/api/session/local';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PlaybackSession);
      _bodyData = _serializers.serialize(playbackSession, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> createLocalSessionAll({
    required BuiltList<PlaybackSession> playbackSession,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BuiltList, [FullType(PlaybackSession)]);
      _bodyData = _serializers.serialize(playbackSession, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> deleteSession({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/sessions/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaybackSessionExpanded>> getSession({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/session/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  ///
  /// Parameters:
  /// * [user] - The ID of the user to filter listening sessions by.
  ...
  Future<Response<String>> syncOpenSession({
    ...
    final _path = r'/api/session/{id}/sync'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
