...
class AuthorsApi {
  ...
  const AuthorsApi(this._dio, this._serializers);
  ...
  /// Parameters:
  /// * [id] - Author ID
  /// * [body] - The author image to add by URL.
  /// * [token] - API token
  /// * [ts] - Updated at value
  ...
  Future<Response<Uint8List>> addAuthorImageById({
    required String id,
    ...
    final _path = r'/api/authors/{id}/image'.replaceAll(
        '{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> deleteAuthorById({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/authors/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteAuthorImageById({
    required String id,
    String? token,
    int? ts,
    CancelToken? cancelToken,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Author] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Author>> getAuthorById({
    required String id,
    String? include,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [token] - API token
  /// * [ts] - Updated at value
  /// * [getAuthorImageByIdRequest] - The author image to get.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Uint8List] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> getAuthorImageById({
    required String id,
    String? token,
    int? ts,
    GetAuthorImageByIdRequest? getAuthorImageByIdRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GetAuthorImageByIdRequest);
      _bodyData = getAuthorImageByIdRequest == null
          ? null
          : _serializers.serialize(getAuthorImageByIdRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Parameters:
  /// * [id] - Author ID
  /// * [matchAuthorByIdRequest] - The author object to match against an online provider.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MatchAuthorById200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MatchAuthorById200Response>> matchAuthorById({
    required String id,
    required MatchAuthorByIdRequest matchAuthorByIdRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/authors/{id}/match'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(MatchAuthorByIdRequest);
      _bodyData =
          _serializers.serialize(matchAuthorByIdRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    MatchAuthorById200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(MatchAuthorById200Response),
            ) as MatchAuthorById200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<MatchAuthorById200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - Author ID
  /// * [updateAuthorByIdRequest] - The author object to update.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateAuthorById200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateAuthorById200Response>> updateAuthorById({
    required String id,
    UpdateAuthorByIdRequest? updateAuthorByIdRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateAuthorByIdRequest);
      _bodyData = updateAuthorByIdRequest == null
          ? null
          : _serializers.serialize(updateAuthorByIdRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    UpdateAuthorById200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UpdateAuthorById200Response),
            ) as UpdateAuthorById200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UpdateAuthorById200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [token] - API token
  /// * [ts] - Updated at value
  /// * [getAuthorImageByIdRequest] - The author image to update.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Uint8List] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> updateAuthorImageById({
    required String id,
    String? token,
    int? ts,
    GetAuthorImageByIdRequest? getAuthorImageByIdRequest,
