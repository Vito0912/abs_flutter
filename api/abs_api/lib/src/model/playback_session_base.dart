...
part 'playback_session_base.g.dart';
...
abstract class PlaybackSessionBase {
  ...
  @BuiltValueField(wireName: r'displayAuthor')
  ...
  static Serializer<PlaybackSessionBase> get serializer =>
      _$PlaybackSessionBaseSerializer();
}

class _$PlaybackSessionBaseSerializer
    implements PrimitiveSerializer<PlaybackSessionBase> {
  @override
  final Iterable<Type> types = const [PlaybackSessionBase];

  @override
  final String wireName = r'PlaybackSessionBase';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PlaybackSessionBase object, {
  ...
  @override
  PlaybackSessionBase deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized,
        specifiedType: FullType($PlaybackSessionBase)) as $PlaybackSessionBase;
  }
}

/// a concrete implementation of [PlaybackSessionBase], since [PlaybackSessionBase] is not instantiable
@BuiltValue(instantiable: true)
abstract class $PlaybackSessionBase
    implements
        PlaybackSessionBase,
        Built<$PlaybackSessionBase, $PlaybackSessionBaseBuilder> {
  $PlaybackSessionBase._();

  factory $PlaybackSessionBase(
          [void Function($PlaybackSessionBaseBuilder)? updates]) =
      _$$PlaybackSessionBase;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($PlaybackSessionBaseBuilder b) => b;
...
class _$$PlaybackSessionBaseSerializer
  ...
  Object serialize(
    ...
    return serializers.serialize(object,
        specifiedType: FullType(PlaybackSessionBase))!;
  }
  ...
  void _deserializeProperties(
    ...
    required PlaybackSessionBaseBuilder result,
  ...
  $PlaybackSessionBase deserialize(
    ...
    final result = $PlaybackSessionBaseBuilder();
