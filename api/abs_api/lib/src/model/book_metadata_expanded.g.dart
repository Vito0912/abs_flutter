...
part of 'book_metadata_expanded.dart';
...
class _$BookMetadataExpanded extends BookMetadataExpanded {
  ...
  @override
  BookMetadataExpanded rebuild(
          void Function(BookMetadataExpandedBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BookMetadataExpandedBuilder toBuilder() =>
      new BookMetadataExpandedBuilder()..replace(this);
...
class BookMetadataExpandedBuilder
    implements
        Builder<BookMetadataExpanded, BookMetadataExpandedBuilder>,
  ...
  @override
  void replace(covariant BookMetadataExpanded other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$BookMetadataExpanded;
  }

  @override
  void update(void Function(BookMetadataExpandedBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BookMetadataExpanded build() => _build();

  _$BookMetadataExpanded _build() {
    _$BookMetadataExpanded _$result;
    try {
      _$result = _$v ??
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'BookMetadataExpanded', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
