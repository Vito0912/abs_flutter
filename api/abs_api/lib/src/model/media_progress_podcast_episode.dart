...
part 'media_progress_podcast_episode.g.dart';
...
@BuiltValue()
abstract class MediaProgressPodcastEpisode
    implements
        Built<MediaProgressPodcastEpisode, MediaProgressPodcastEpisodeBuilder> {
  ...
  MediaProgressPodcastEpisode._();

  factory MediaProgressPodcastEpisode(
          [void updates(MediaProgressPodcastEpisodeBuilder b)]) =
      _$MediaProgressPodcastEpisode;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MediaProgressPodcastEpisodeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MediaProgressPodcastEpisode> get serializer =>
      _$MediaProgressPodcastEpisodeSerializer();
}

class _$MediaProgressPodcastEpisodeSerializer
    implements PrimitiveSerializer<MediaProgressPodcastEpisode> {
  @override
  ...
  @override
  final String wireName = r'MediaProgressPodcastEpisode';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MediaProgressPodcastEpisode object, {
  ...
  void _deserializeProperties(
    ...
    required MediaProgressPodcastEpisodeBuilder result,
  ...
  @override
  MediaProgressPodcastEpisode deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MediaProgressPodcastEpisodeBuilder();
