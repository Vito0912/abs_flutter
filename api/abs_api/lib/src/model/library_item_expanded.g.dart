...
part of 'library_item_expanded.dart';
...
class _$LibraryItemExpanded extends LibraryItemExpanded {
  ...
  factory _$LibraryItemExpanded(
          [void Function(LibraryItemExpandedBuilder)? updates]) =>
      (new LibraryItemExpandedBuilder()..update(updates))._build();

  _$LibraryItemExpanded._(
      {this.size,
      this.id,
  ...
  @override
  LibraryItemExpanded rebuild(
          void Function(LibraryItemExpandedBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LibraryItemExpandedBuilder toBuilder() =>
      new LibraryItemExpandedBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LibraryItemExpanded &&
        size == other.size &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LibraryItemExpanded')
          ..add('size', size)
          ..add('id', id)
...
class LibraryItemExpandedBuilder
    implements
        Builder<LibraryItemExpanded, LibraryItemExpandedBuilder>,
        LibraryItemBaseBuilder {
  _$LibraryItemExpanded? _$v;
  ...
  LibraryItemExpandedBuilder() {
    LibraryItemExpanded._defaults(this);
  }

  LibraryItemExpandedBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _size = $v.size;
      _id = $v.id;
  ...
  @override
  void replace(covariant LibraryItemExpanded other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$LibraryItemExpanded;
  }

  @override
  void update(void Function(LibraryItemExpandedBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LibraryItemExpanded build() => _build();

  _$LibraryItemExpanded _build() {
    _$LibraryItemExpanded _$result;
    try {
      _$result = _$v ??
          new _$LibraryItemExpanded._(
              size: size,
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'LibraryItemExpanded', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
