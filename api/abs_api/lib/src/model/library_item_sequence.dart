...
part 'library_item_sequence.g.dart';
...
@BuiltValue()
abstract class LibraryItemSequence
    implements
        LibraryItemBase,
        Built<LibraryItemSequence, LibraryItemSequenceBuilder> {
  /// The position in the series the book is.
  @BuiltValueField(wireName: r'sequence')
  String? get sequence;

  LibraryItemSequence._();

  factory LibraryItemSequence([void updates(LibraryItemSequenceBuilder b)]) =
      _$LibraryItemSequence;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LibraryItemSequenceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LibraryItemSequence> get serializer =>
      _$LibraryItemSequenceSerializer();
}

class _$LibraryItemSequenceSerializer
    implements PrimitiveSerializer<LibraryItemSequence> {
  @override
  ...
  @override
  final String wireName = r'LibraryItemSequence';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LibraryItemSequence object, {
  ...
  void _deserializeProperties(
    ...
    required LibraryItemSequenceBuilder result,
  ...
  @override
  LibraryItemSequence deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LibraryItemSequenceBuilder();
