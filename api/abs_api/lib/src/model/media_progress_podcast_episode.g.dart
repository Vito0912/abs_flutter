...
part of 'media_progress_podcast_episode.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$MediaProgressPodcastEpisode extends MediaProgressPodcastEpisode {
  @override
  final String? id;
  @override
  ...
  factory _$MediaProgressPodcastEpisode(
          [void Function(MediaProgressPodcastEpisodeBuilder)? updates]) =>
      (new MediaProgressPodcastEpisodeBuilder()..update(updates))._build();

  _$MediaProgressPodcastEpisode._(
      {this.id,
      this.libraryItemId,
      this.episodeId,
      this.duration,
  ...
  @override
  MediaProgressPodcastEpisode rebuild(
          void Function(MediaProgressPodcastEpisodeBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MediaProgressPodcastEpisodeBuilder toBuilder() =>
      new MediaProgressPodcastEpisodeBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MediaProgressPodcastEpisode &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MediaProgressPodcastEpisode')
          ..add('id', id)
...
class MediaProgressPodcastEpisodeBuilder
    implements
        Builder<MediaProgressPodcastEpisode,
            MediaProgressPodcastEpisodeBuilder> {
  _$MediaProgressPodcastEpisode? _$v;
  ...
  MediaProgressPodcastEpisodeBuilder() {
    MediaProgressPodcastEpisode._defaults(this);
  }

  MediaProgressPodcastEpisodeBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(MediaProgressPodcastEpisode other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MediaProgressPodcastEpisode;
  }

  @override
  void update(void Function(MediaProgressPodcastEpisodeBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MediaProgressPodcastEpisode build() => _build();

  _$MediaProgressPodcastEpisode _build() {
    final _$result = _$v ??
        new _$MediaProgressPodcastEpisode._(
            id: id,
