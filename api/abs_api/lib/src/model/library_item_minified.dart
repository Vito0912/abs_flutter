...
part 'library_item_minified.g.dart';
...
/// * [media]
@BuiltValue()
abstract class LibraryItemMinified
    implements
        LibraryItemBase,
        Built<LibraryItemMinified, LibraryItemMinifiedBuilder> {
  LibraryItemMinified._();

  factory LibraryItemMinified([void updates(LibraryItemMinifiedBuilder b)]) =
      _$LibraryItemMinified;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LibraryItemMinifiedBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LibraryItemMinified> get serializer =>
      _$LibraryItemMinifiedSerializer();
}

class _$LibraryItemMinifiedSerializer
    implements PrimitiveSerializer<LibraryItemMinified> {
  @override
  ...
  @override
  final String wireName = r'LibraryItemMinified';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LibraryItemMinified object, {
  ...
  void _deserializeProperties(
    ...
    required LibraryItemMinifiedBuilder result,
  ...
  @override
  LibraryItemMinified deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LibraryItemMinifiedBuilder();
