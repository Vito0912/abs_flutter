...
part of 'playback_session_book.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract class PlaybackSessionBookBuilder
    implements PlaybackSessionBaseBuilder {
  void replace(covariant PlaybackSessionBook other);
  void update(void Function(PlaybackSessionBookBuilder) updates);
...
class _$$PlaybackSessionBook extends $PlaybackSessionBook {
  @override
  ...
  factory _$$PlaybackSessionBook(
          [void Function($PlaybackSessionBookBuilder)? updates]) =>
      (new $PlaybackSessionBookBuilder()..update(updates))._build();

  _$$PlaybackSessionBook._(
      {this.chapters,
      this.mediaMetadata,
      this.id,
      this.userId,
  ...
  @override
  $PlaybackSessionBook rebuild(
          void Function($PlaybackSessionBookBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $PlaybackSessionBookBuilder toBuilder() =>
      new $PlaybackSessionBookBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $PlaybackSessionBook &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$PlaybackSessionBook')
...
class $PlaybackSessionBookBuilder
    implements
        Builder<$PlaybackSessionBook, $PlaybackSessionBookBuilder>,
        PlaybackSessionBookBuilder {
  _$$PlaybackSessionBook? _$v;
  ...
  $PlaybackSessionBookBuilder() {
    $PlaybackSessionBook._defaults(this);
  }

  $PlaybackSessionBookBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  void replace(covariant $PlaybackSessionBook other) {
    ...
    _$v = other as _$$PlaybackSessionBook;
  }
  ...
  @override
  $PlaybackSessionBook build() => _build();

  _$$PlaybackSessionBook _build() {
    _$$PlaybackSessionBook _$result;
    try {
      _$result = _$v ??
          new _$$PlaybackSessionBook._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$PlaybackSessionBook', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
