...
part of 'library_item_minified.dart';
...
class _$LibraryItemMinified extends LibraryItemMinified {
  ...
  factory _$LibraryItemMinified(
          [void Function(LibraryItemMinifiedBuilder)? updates]) =>
      (new LibraryItemMinifiedBuilder()..update(updates))._build();

  _$LibraryItemMinified._(
      {this.id,
  ...
  @override
  LibraryItemMinified rebuild(
          void Function(LibraryItemMinifiedBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LibraryItemMinifiedBuilder toBuilder() =>
      new LibraryItemMinifiedBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LibraryItemMinified &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LibraryItemMinified')
          ..add('id', id)
...
class LibraryItemMinifiedBuilder
    implements
        Builder<LibraryItemMinified, LibraryItemMinifiedBuilder>,
        LibraryItemBaseBuilder {
  _$LibraryItemMinified? _$v;
  ...
  LibraryItemMinifiedBuilder() {
    LibraryItemMinified._defaults(this);
  }

  LibraryItemMinifiedBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(covariant LibraryItemMinified other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$LibraryItemMinified;
  }

  @override
  void update(void Function(LibraryItemMinifiedBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LibraryItemMinified build() => _build();

  _$LibraryItemMinified _build() {
    _$LibraryItemMinified _$result;
    try {
      _$result = _$v ??
          new _$LibraryItemMinified._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'LibraryItemMinified', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
