...
part 'book_metadata_minified.g.dart';
...
@BuiltValue()
abstract class BookMetadataMinified
    implements
        BookMetadataBase,
        Built<BookMetadataMinified, BookMetadataMinifiedBuilder> {
  ...
  BookMetadataMinified._();

  factory BookMetadataMinified([void updates(BookMetadataMinifiedBuilder b)]) =
      _$BookMetadataMinified;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BookMetadataMinifiedBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BookMetadataMinified> get serializer =>
      _$BookMetadataMinifiedSerializer();
}

class _$BookMetadataMinifiedSerializer
    implements PrimitiveSerializer<BookMetadataMinified> {
  @override
  ...
  @override
  final String wireName = r'BookMetadataMinified';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BookMetadataMinified object, {
  ...
  void _deserializeProperties(
    ...
    required BookMetadataMinifiedBuilder result,
  ...
  @override
  BookMetadataMinified deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BookMetadataMinifiedBuilder();
