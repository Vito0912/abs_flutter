  ...
  Widget _switch(BuildContext context) {
    return Consumer(
      ...
      return SettingsTile.switchTile(
          ...
          description: _boolText(keyValue, defaultValue, S.of(context).enabled,
              S.of(context).disabled),
          onToggle: (value) {
            userSharedPreferences.setBool(keyValue, value);
          },
          initialValue: userSharedPreferences.getBool(keyValue,
                  defaultValue: defaultValue) ??
              defaultValue);
    });
  }

  PlatformText _boolText(
      String key, bool defaultValue, String trueText, String falseText) {
    bool value =
        userSharedPreferences.getBool(key, defaultValue: defaultValue) ??
            defaultValue;
