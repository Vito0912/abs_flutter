...
abstract class $ChapterCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, double start, double end});
}
...
class _$ChapterImpl extends _Chapter with DiagnosticableTreeMixin {
  _$ChapterImpl({required this.title, required this.start, required this.end})
      : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Chapter(title: $title, start: $start, end: $end)';
  }
...
abstract class _Chapter extends Chapter {
  factory _Chapter(
      ...
      required double end}) = _$ChapterImpl;
  _Chapter._() : super._();
